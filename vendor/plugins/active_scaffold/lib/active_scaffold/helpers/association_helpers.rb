  ...
  module Helpers
    module AssociationHelpers
      ...
      def association_options_find(association, conditions = nil)
        ...
        association.klass.find(:all, :conditions => controller.send(:merge_conditions, find_conditions, association.options[:conditions]), :order => find_order)
      end
      ...
      def association_options_count(association, conditions = nil)
        ...
        association.klass.count(:all, :conditions => controller.send(:merge_conditions, find_conditions, association.options[:conditions]))
      end
